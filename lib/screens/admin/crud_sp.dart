...
class _AddEditSanPhamScreenState extends State<AddEditSanPhamScreen> {
  ...
  final TextEditingController _trangThaiController = TextEditingController();
  ...
  void initState() {
    ...
    if (widget.sanPham != null) {
      ...
      _trangThaiController.text = sp.trangthai ?? 'Hiện';
  ...
  Future<void> _saveSanPham() async {
    if (_formKey.currentState!.validate()) {
      ...
      final sp = SanPham(
        ...
        trangthai: _trangThaiController.text.trim(),
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                value: _trangThaiController.text.isEmpty ? 'Hiện' : _trangThaiController.text,
                ...
                onChanged: (val) {
                  setState(() {
                    _trangThaiController.text = val ?? 'Hiện';
                  });
                },
              ),
              const SizedBox(height: 12),
