...
//               color: Colors.grey.shade100, // Nền nhạt cho khối lọc
//               borderRadius: BorderRadius.circular(12),
//               boxShadow: [
//                 BoxShadow(
...
//           final result = await Navigator.push(
//               context,
//               MaterialPageRoute(builder: (context) => const AddEditSanPhamScreen())
//           );
//           if(_sanPhams == true)
//           {
//             _loadSanPhams();
//             ScaffoldMessenger.of(context).showSnackBar(
//               const SnackBar(content: Text('Thêm sản phẩm thành coong'))
//             );
//           }
//
//         },
